            ...
            "tool": {
                "driver": {
                    ...
                    "rules": [{
                        ...
                        "fullDescription": {
                            "text": "Duplicate sections of code increase the risk of development errors, especially if fixes are made to one code block but not the other. Duplicate code which share the same abstractions should be refactored into reusable helper methods as an application of the Don't Repeat Yourself principle."
                        },

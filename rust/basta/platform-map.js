...
const PLATFORM_MAP = {
  "linux-x64-gnu": {
    packageName: "basta-linux-x64-gnu",
    os: "linux",
    cpu: "x64",
    libc: "glibc",
  ...
  "linux-arm64-gnu": {
    packageName: "basta-linux-arm64-gnu",
    os: "linux",
    cpu: "arm64",
    libc: "glibc",
  ...
  "linux-x64-musl": {
    packageName: "basta-linux-x64-musl",
    os: "linux",
    cpu: "x64",
    libc: "musl",
  ...
  "linux-arm64-musl": {
    packageName: "basta-linux-arm64-musl",
    os: "linux",
    cpu: "arm64",
    libc: "musl",
  ...
  "darwin-arm64": {
    packageName: "basta-darwin-arm64",
    os: "darwin",
    cpu: "arm64",
  ...
  "windows-x64-msvc": {
    packageName: "basta-windows-x64-msvc",
    os: "win32",
    cpu: "x64",
  ...
  "windows-arm64-msvc": {
    packageName: "basta-windows-arm64-msvc",
    os: "win32",
    cpu: "arm64",
